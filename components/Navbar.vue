  ...
  <div style="font-family: 'Montserrat', sans-serif">
    ...
    >
      <div class="flex flex-wrap items-center lg:gap-y-2 gap-4 w-full">
        ...
        <div class=" ">
          <div>
              <a href="/"> <img src="~/assets/images/task1.png" alt="Task Icon" style="width: 45px; height: 45px;">
</a> 
          </div>
        </div>
        ...
        <div class="flex gap-x-6 gap-y-4 ml-auto">
          ...
          >
            ...
            <li class="max-lg:border-b max-lg:py-1 px-3">
              <a
                href="/"
                class="text-[#000] hover:text-[#08aa71] text-[15px] block font-semibold"
                >Dashboard</a
              >
            </li>
            <li class="max-lg:border-b max-lg:py-1 px-3">
              <a
                href="/TaskManager"
                class="text-[#333] hover:text-[#08aa71] text-[15px] block font-semibold"
                >Manage Task</a
              >
            </li>
            <li class="max-lg:border-b max-lg:py-1 px-3">
